...
This is a free to use package for anyone who has the need. However, users must adhere to the licensing agreement of some dependencies that require that their packages be used only for educational and research purposes.
