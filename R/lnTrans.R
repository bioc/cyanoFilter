# log transforms the expression matrix of a flowframe @param x flowframe to be transformed @param notToTransform columns not to be transformed @return
# \strong{flowframe} with log transformed expression matrix @examples \dontrun{ lnTrans(margin_filtered$Day1[[1]], c('YEL.B.HLin', 'TIME')) } @export
# lnTrans
